...
f)  To investigate the effect of the predictors on the baby weight, apply a logistic regression model (no interactions). Interpret the results in terms of odds, comment, compare to e).
